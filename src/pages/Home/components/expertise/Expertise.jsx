...
export default function Expertise () {
    return (
        <div className={styles.section4}>
            ...
            <GlobalCard width='23%' icon={icon1} heading='Dedicated Teams' bottom='Find your next team member' />
            <GlobalCard width='23%' icon={icon2} heading='Staff Augmentation' bottom='Build a distributed development team' />
            <GlobalCard width='23%' icon={icon3} heading='Software Outsourcing' bottom='End-to-End Software Development Outsourcing Solutions' />
            <GlobalCard width='23%' icon={icon4} heading='Remote Office' bottom='Open your own remote development center and grow your business' />
            </div>
        </Container>
        </div>
    )
